  ...
  return (
    <div className="relative">
      <div
        ...
        className="bg-neutral-50 border border-neutral-300 dark:border-[#2e2e2e] dark:bg-[#1f1f1f] rounded-lg p-5 flex flex-col gap-2 min-h-64"
      >
        ...
        {status === "active" && (
          <UpdatedGoalDialog
            goal={{ title, targetAmount, spent, date, id, index }}
          />
        )}
      </div>
      {status === "expired" && (
