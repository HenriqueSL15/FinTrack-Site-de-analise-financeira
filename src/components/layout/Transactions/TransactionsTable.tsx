        ...
        {filteredTransactions.map((transaction, i) => {
          return (
            ...
            >
              <td
                className="p-4 w-[20%]"
                data-testid={`transactionRow-${i}-transactionDate`}
              >
                {transaction.createdAt.split("T")[0].replace(/-/g, "/")}
              </td>
              <td
                className="min-w-20"
                data-testid={`transactionRow-${i}-transactionDescription`}
              >
                {transaction.description}
              </td>
              <td data-testid={`transactionRow-${i}-transactionCategory`}>
              ...
              <td>
                <h1
                  ...
                  data-testid={`transactionRow-${i}-transactionType`}
                >
                  {transaction.type === "income" ? (
                    <ArrowUp size={18} />
                  ) : (
              ...
              <td
                ...
                data-testid={`transactionRow-${i}-transactionAmount`}
              >
